...
public abstract class Nucleus implements Cloneable
{
	protected ArrayList<Chromosome> chromosomes;
	protected double mutability;
	...
	public abstract List<AbstractWaveletGene> getGenes();
	...
	public Set<SignalKey> getExpressedSignals(boolean external)
	{
